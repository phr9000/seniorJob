...
const SelectBoxBasic: React.FC = () => {
  ...
  const [ items, setItems ] = useState([
    'All', 'Bedok', 'Bishan', 'Bukit Batok', 'Bukit Merah', 'Bukit Panjang',
    'Bukit Timah', 'Geylang', 'Changi', 'Hougang', 'Jurong East', 'Jurong Island', 'Kallang'
  ]);
      ...
      <div className="dropdown_area select_basic">
        ...
        {isOpen && (
          <div className="dropdown_menu">
            <ul>
              {items.map(item => (
                <li className="_item" key={item} onClick={() => selectItem(item)}>
