      ...
      <div className="jobs-detail-container">
        ...
        <div className="right">
          ...
          <div className="bottom">
            <h2>Courses for Jobseekers</h2>
            <p>
              We offer a variety of courses for our senior jobseekers to upgrade
              their skillsets. You may browse the entire list of courses here.
            </p>
            <button className="btn btn-full btn-blue-fill">
              Browse All Courses&nbsp;&nbsp;
