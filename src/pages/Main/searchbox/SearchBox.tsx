...
const SearchBox: React.FC = () => {
  ...
  const [selectedItems1, setSelectedItems1] = useState<string[]>([]); //eslint-disable-line no-unused-vars

  // 두 번째 SelectBoxChk 컴포넌트에 대한 상태와 콜백 함수
  const [isDropdownOpen2, setIsDropdownOpen2] = useState(false);
  const [selectedItems2, setSelectedItems2] = useState<string[]>([]); //eslint-disable-line no-unused-vars
  return (
    <>
